      ...
      if (lop) {
        if (khoa) {
          if (nganh) {
            ...
            alert('Please fill Vị trí');
          }
        } else {
          alert('Please fill Trình độ học vấn');
        }
      } else {
        alert('Please fill Quê Quán');
      }
    }else{
      alert('Please fill Năm Sinh');
    }
  }else{
    alert('Please fill Tên Nhân viên');
  }
      }else{
            alert('Please fill Mã Nhân viên');
          }
  };
